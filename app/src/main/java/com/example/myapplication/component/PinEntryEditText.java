...
public class PinEntryEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedValue outValue = new TypedValue();
        int colorSelected = R.color.black;
        mColors[0] = colorSelected;

        int colorFocused = isInEditMode() ? R.color.black : R.color.black;
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ? R.color.black : R.color.black;
    ...
    private int getColorForState(int... states) {
        return mColorStates.getColorForState(states, ContextCompat.getColor(getContext(),R.color.black));
    }
